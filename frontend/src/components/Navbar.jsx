...
const Navbar = () => {
  return (
    ...
    <nav class="flex items-center justify-between ml-5 p-4 mr-10 relative cursor-pointer">
        ...
        <Link to={"/"}><p className='  pt-2 text-gray-600 lg:text-xl hover:text-cyan-700 hover:underline'>Product page</p></Link>
         <Link to={"/cart"}> <p className='pt-2 text-gray-600 lg:text-xl hover:text-cyan-700 hover:underline'>Cart page</p></Link>   
